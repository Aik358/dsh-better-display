...
export function OfficialTail({ official, owner, produced }) {
    ...
    return official && tailOwner ? _jsx("div", { "data-reader-official-tail": true, style: { display: 'contents' }, children: official.renderSlotChain(OFFICIAL_SEATS.tail, tailOwner) }) : null;
}
