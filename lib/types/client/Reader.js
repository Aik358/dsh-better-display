...
export function Reader(props) {
    ...
    return _jsx(StreamMotionContext.Provider, { value: streamMotion, children: _jsxs("div", { ref: root, className: css.root, "data-dsh-better-display": "0.1.1", "data-reader-wait-clock-version": "input-v1", "data-reader-wait-start": waitAnchor.time ?? undefined, "data-motion": motion ? 'on' : 'off', children: [_jsx(TimelineRail, { items: timelineItems, activeTurn: activeTurn, busyTurn: busyTurn, onNavigate: onNavigateTurn }), _jsxs("div", { className: css.column, children: [_jsxs(StickyLane, { kind: "toolbar", className: css.toolbar, children: [_jsx("button", { type: "button", className: css.textButton, "aria-pressed": autoFold, onClick: () => props.actions.setAutoFold(!autoFold), title: "\u65B0\u601D\u8003\u4EA7\u751F\u65F6\uFF0C\u662F\u5426\u81EA\u52A8\u5C06\u6B64\u524D\u6B65\u9AA4\u6536\u62E2\u4E3A\u4E00\u884C\u6C47\u603B\u3002\u5173\u95ED\u540E\u5B8C\u6574\u4FDD\u7559\u539F\u59CB\u8FC7\u7A0B\u4E0E\u6D41\u5F0F\u8F93\u51FA\u3002", children: `自动折叠${autoFold ? '开' : '关'}` }), _jsx("button", { type: "button", className: css.textButton, "aria-pressed": processOnly, onClick: () => props.actions.setProcessOnly(!processOnly), title: "\u53EA\u6298\u53E0\u601D\u8003\u4E0E\u5DE5\u5177\u8C03\u7528\uFF0C\u4FDD\u7559\u6BCF\u6BB5\u5BF9\u5916\u8F93\u51FA\u7684\u6B63\u6587\u5B8C\u6574\u53EF\u8BFB\u3002", children: `只折叠过程${processOnly ? '开' : '关'}` })] }), hasMore && _jsx("button", { type: "button", className: css.historyButton, disabled: loadingOlder, onClick: async () => {
