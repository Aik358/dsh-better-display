...
export function MotionMarkdown({ text, streaming, enabled, revision, fileMentions }) {
    ...
    return _jsx(WordScope.Provider, { value: scope, children: _jsx(MarkdownText, { text: text, streaming: streaming, codeLabels: CODE_LABELS, fileMentions: fileMentions, pathImages: readerPathImages, renderText: renderText, renderAtom: renderAtom }) });
}
